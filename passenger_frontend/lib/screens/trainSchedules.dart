...
try {
  ...
  final response = await trainScheduleService.getSchedules(
      widget.reservationTicket);
      ...
      setState(() {
        _schedules = data
            ...
            Schedule(
                ...
                endStation: scheduleData['endStation'] ?? '',
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          final schedule = _schedules[index]; // Get the schedule at the current index
          ...
          return Column(
            children: [
              ...
              SizedBox(height: 16.0), // Example: Adds 16 pixels of vertical space
